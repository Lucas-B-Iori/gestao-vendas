...
public class Botao extends JButton {
    ...
    public Botao() {
        ...
        TimingTarget target = new TimingTargetAdapter() {
            ...
            public void timingEvent(float fraction) {
                ...
                tamanhoDaAnimator = fraction * alfa;
                repaint();
            }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (ponto != null) {
            ...
            graphics2D.fillOval((int) (ponto.x - tamanhoDaAnimator / 2), (int) (ponto.y - tamanhoDaAnimator / 2), (int) tamanhoDaAnimator, (int) tamanhoDaAnimator);
        }
